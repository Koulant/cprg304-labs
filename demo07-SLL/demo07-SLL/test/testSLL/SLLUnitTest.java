...
import linkedListImplementation.SLL;
 ...
 *
 */
public class SLLUnitTest {
	//Attributes
	private SLL<Integer> myList;
	private LinkedList<Integer> jList;
	private Integer one;
	private Integer two;
	...
	/**
	 * Test method for {@link linkedListImplementation.SLL#add(int, java.lang.Object)}.
	 */
	@Test
	public void testAddIntE_returnTrue()
	{
		...
		assertEquals("Add did not return a boolean correctly.",
	...
	/**
	 * Test method for {@link linkedListImplementation.SLL#add(java.lang.Object)}.
	 */
	@Test
	...
	public void testAddE_ResizeArray()
	{
		...
		assertEquals("Size of list was not increased correctly after resize.",
	...
	/**
	 * Test method for {@link linkedListImplementation.SLL#addAll(utilities.List)}.
	 */
	@Test
	public void testAddAll_returnTrue()
	{
		boolean expected = true;
		SLL<Integer> intArray = new SLL<>();
		intArray.add(three);
		intArray.add(four);
		intArray.add(five);
	...
	/**
	 * Test method for {@link linkedListImplementation.SLL#clear()}.
	 */
	@Test
	public void testClear_Size()
	{
		...
		assertEquals("List was not cleared correctly.",
				expected, actual);
	}

	/**
	 * Test method for {@link linkedListImplementation.SLL#contains(java.lang.Object)}.
	 */
	@Test
	public void testContains_returnTrue()
	{
		...
		assertEquals("Element was not correctly found in the current list.",
				expected, actual);
	}
	...
	public void testContains_returnFalse()
	{
		...
		assertEquals("Element found in current list and should not be found.",
				expected, actual);
	}

	/**
	 * Test method for {@link linkedListImplementation.SLL#get(int)}.
	 */
	@Test
	 ...
	 */
	@Test
	public void testGetInt_IndexOutOfBoundsException_InvalidIndex() 
	{
		myList.add(one);
		myList.add(two);
		myList.add(three);
	...
	/**
	 * Test method for {@link linkedListImplementation.SLL#isEmpty()}.
	 */
	@Test
	...
	/**
	 * Test method for {@link linkedListImplementation.SLL#iterator()}.
	 */
	@Test
	public void testIterator_Head()
	{
		...
		assertEquals("Iterator returned incorrect value at 1st position.", expected, actual);
	}
	...
	public void testIterator_Tail()
	{
		...
		int actual = value.intValue();
		assertEquals("Iterator returned incorrect value at the last position.", expected, actual);
	}

	/**
	 * Test method for {@link linkedListImplementation.SLL#remove(int)}.
	 */
	@Test
	...
	/**
	 * Test method for {@link linkedListImplementation.SLL#remove(E)}.
	 */
	@Test
	 ...
	 */
	@Test
	public void testRemoveE_NotFound()
	{
		myList.add(one);
		myList.add(two);
		myList.add(three);
	...
	/**
	 * Test method for {@link linkedListImplementation.SLL#set(int, E)}.
	 */
	@Test
	public void testSet_SpecificIndex()
	{
		...
		assertEquals("Original element not returned correctly after Set.",
				expected1, actual1);
	...
	public void testSet_Head()
	{
		...
		assertEquals("Original element was not returnyed correctly.", expected1, actual1);
	...
	/**
	 * Test method for {@link linkedListImplementation.SLL#size()}.
	 */
	@Test
	public void testSize_AddOneToEmpty() 
	{
		...
		int actual = myList.size();
		assertEquals("Size of the array was not returned correctly.",
				expected, actual);
	}
	...
	/**
	 * Test method for {@link linkedListImplementation.SLL#toArray(E[])}.
	 */
	@Test
	...
	/**
	 * Test method for {@link linkedListImplementation.SLL#toArray()}.
	 */
	@Test
