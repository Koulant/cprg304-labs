 ...
 * @version 1.1
 *
 * Class Description:  Implementation of a Singly Linked List node.
 * This node consists of a element and a link to its
...
public class SLLNode<E> implements Serializable
{
	...
	// Constructors
	/**
	* Constructs a SLL node with an element and 
	* a successor.
	*
