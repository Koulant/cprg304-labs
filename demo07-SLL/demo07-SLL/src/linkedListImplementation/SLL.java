 ...
 * @version 1.2
 *
 * Class Description: Implementation of the List interface as a Singly 
 * Linked List (SLL). Positions are zero-based (e.g. index 0 = first
 * position = first element/node.
 */
...
public class SLL<E> implements ListADT<E>
{
	...
	/**
	 * Method to add an element to a specific index in a list.  
	 * If the index is an index outside of the bounds of the list
			...
			throws NullPointerException, IndexOutOfBoundsException
	{
		...
		if(index < 0 || index > size)
		{
			throw new IndexOutOfBoundsException(
					"Index is outside current list boundary '"+index+"'");
		}
	...
	/**
	 * Method to add an element to the end of a List. If the list is
	...
	/**
	 * Appends all of the elements of the list passed into the method
	 * to the end of this list, in the order that they are according to
	 * the logical position of the list being appended.
	 * 
	 ...
	 * @return reference to the element previously stored at the specified 
	 * index
	 * @throws IndexOutOfBoundsException when the index is 
	 * <code>(index < 0 || index >= size())</code>
	 */
	 ...
	 * 
	 * @return the array containing all the elements of the list in the proper order.
	 * (first element at index 0, last element at index n-1)
	 */
	...
	/**
	 * Returns a new instance of an iterator for this list in proper order.
